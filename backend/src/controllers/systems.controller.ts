...
4. **NO generes un encabezado de módulo con el nombre de la clase al inicio del HTML.** El sistema ya muestra el nombre de la clase, la materia y los contenidos en un cabezal propio antes del bloque HTML. Comenzá el HTML directamente con el contenido (primer bloque de contenido), sin ningún título o banner introductorio que repita el nombre de la clase o del módulo.

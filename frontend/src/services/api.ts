...
export const coursesApi = {
  ...
  update: (id: string, data: { name?: string; folderId?: string | null; languages?: string; moodleCourseId?: string | null; moodleCourseName?: string | null; releaseMode?: string; startDate?: string | null; prerequisiteCourseId?: string | null; defaultViewMode?: string; showClassBadges?: boolean }) =>
...
export const previewApi = {
  share: (courseId: string, courseName?: string) =>
    apiFetch<{ token: string; url: string; bypassToken?: string; permanent: boolean }>('/api/preview', {
      method: 'POST',
